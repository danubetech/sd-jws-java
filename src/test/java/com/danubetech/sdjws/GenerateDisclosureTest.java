...
public class GenerateDisclosureTest {
	...
	public void testGenerateDisclosure1() throws Exception {
		...
		assertEquals(disclosure1.getDisclosureDigest(), "K_gXSSjPJbk7jJ--NTqkGz5cmZRA_Fn2gMnW0RVuMTo");
	}
	...
	public void testGenerateDisclosure2() throws Exception {
		...
		assertEquals(disclosure2.getDisclosureDigest(), "o7CydxeKIJp_37diqSifclzb1utexIs9cn7Vtu5f4dU");
	}
}
